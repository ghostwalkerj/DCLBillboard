...
import DCLBillboardDeployment from "./deployments/localhost/DCLBillboard.json";
import { DCLBillboard } from "./typechain/DCLBillboard";
import { DCLBillboard__factory } from "./typechain/factories/DCLBillboard__factory";
...
export const DCLBillboardContext = React.createContext<SymfoniDCLBillboard>(emptyContract);
...
export interface SymfoniDCLBillboard {
    instance?: DCLBillboard;
    factory?: DCLBillboard__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const [DCLBillboard, setDCLBillboard] = useState<SymfoniDCLBillboard>(emptyContract);
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const doAsync = async () => {
            ...
            const finishWithContracts = (text: string) => {
                setDCLBillboard(getDCLBillboard(_provider, _signer))
                finish(text)
            }
    ...
    const getDCLBillboard = (_provider: providers.Provider, _signer?: Signer) => {

        const contractAddress = DCLBillboardDeployment.receipt.contractAddress
        const instance = _signer ? DCLBillboard__factory.connect(contractAddress, _signer) : DCLBillboard__factory.connect(contractAddress, _provider)
        const contract: SymfoniDCLBillboard = {
            instance: instance,
            factory: _signer ? new DCLBillboard__factory(_signer) : undefined,
        }
        return contract
    }
        ;
            ...
            <ProviderContext.Provider value={[provider, setProvider]}>
                <SignerContext.Provider value={[signer, setSigner]}>
                    <CurrentAddressContext.Provider value={[currentAddress, setCurrentAddress]}>
                        <DCLBillboardContext.Provider value={DCLBillboard}>
                            {showLoading && loading ?
